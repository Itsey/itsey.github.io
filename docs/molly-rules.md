...
#### <a name="MC0002"></a> MC0002 - Lazy File Denylist.
...
Only a well known directory structure is permitted at the root level of the repository, only the following folders are permitted at the root level.  Note that the primary src folder must exist for MC0060, butt his allows other secondary solutions to be stored with src_ as a prefix.
